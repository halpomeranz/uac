...
- `ssh/private_keys_with_null_passphrases.yaml`: Added collection of SSH private keys with null passphrases [all]. (by [halpomeranz](https://github.com/halpomeranz))
